...
<html>
	...
	<body>
		...
		<div class="container" id="margin" onClick = "alert('You have logged in as BACKER!\nPlease login as FOUNDER to access this page.');">
				 		...
				 		<div class="row">
							<div class="col-md-5">
				 				<div class="container">
							 		...
							 		<input type="text" name="name" class="form-control" placeholder="Name" disabled="<?php $isDisabled?>">
							 		<span>
							 		...
							 		<input type="text" name="org_name" class="form-control"  placeholder="Oragnization Name" disabled="<?php $isDisabled?>" >
									</div>
									...
									<div class="InputWithIcon">
							 		...
							 		<input type="email" name="email" class="form-control"  placeholder="Enter Email" disabled="<?php $isDisabled?>">
									</div>
									...
									<div class="InputWithIcon">
							 		...
							 		<input type="text" name="pro_title" class="form-control" name="key" placeholder="Project Title" disabled="<?php $isDisabled?>">
									</div>

									<div class="InputWithIcon">
							 		<label for="input name">Category</label>
							 		<select name="streamName" class="form-control" disabled="<?php $isDisabled?>">
									...
									<div class="InputWithIcon">
							 		...
							 		<input type="number" name="fund" class="form-control"  placeholder="Enter fund amount" disabled="<?php $isDisabled?>">
									</div>
									...
									<div class="InputWithIcon">
							 		...
							 		<input type="number" name="milestone"  class="form-control"  placeholder="Milestone to be achieved" disabled="<?php $isDisabled?>">
									</div>

									<div class="InputWithIcon">
							 		<label for="input name">Time Period</label>
							 		<input type="date" name="time" class="form-control"  disabled="<?php $isDisabled?>">
									</div>
				 				...
				 				<div class="col-md-7">
							 		 ...
							 		 <textarea class="form-control" name="descp_brief" rows=6 placeholder="Enter Camapign Brief Description" disabled="<?php $isDisabled?>"></textarea>
							 		</div>

							 		 <div class="InputWithIcon">
							 		 <label for="input name">Project Detail Description</label>
							 		 <textarea class="form-control" name="text" rows=14 placeholder="Enter Project Detail Description" disabled="<?php $isDisabled?>"></textarea>
							 		</div>
				 				...
				 				<div class="col-md-12 btn-style">
				 					<input type="submit" name="publish" class="btn btn-primary " value="Create Campaign" disabled="<?php $isDisabled?>">
				 				</div>
						</div>
				 	</div>
				</form>
		</div>
	  <footer  class="footer-distributed" style="margin-top:80px;">
