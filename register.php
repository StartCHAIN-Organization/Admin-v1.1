	...
	<body>
		...
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="registerdb.php" method="post">
					...
					<div class="container-login100-form-btn">
						<input type="submit" name="register" value="register" class="login100-form-btn" onclick="generateID();">
					</div>
